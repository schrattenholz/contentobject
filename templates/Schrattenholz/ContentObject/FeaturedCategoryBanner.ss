...
-->
        <div class="col-md-5"> sdfgsdf
          <div class="d-flex flex-column h-100 overflow-hidden rounded-lg rounded-big-bottom-right" style="background-color: #e2e9ef;">
            ...
            </div><a class="d-none d-md-block " href="$Category.Link" ><img class="d-block w-100" src="<% if $MainImage %>$MainImage.Fill(500,500).URL<% else %>$Category.DefaultImage.Fill(500,500).URL<% end_if %>" alt="$Category.Title"></a>
          </div>
        </div> 